...
//        // Validate if the 'id' parameter is provided and is a valid integer
//        if (id == null || !id.matches("\\d+")) {
//            resp.setContentType("text/plain");
//            resp.setCharacterEncoding("UTF-8");
//            resp.getWriter().write("Error: Invalid or missing 'id' parameter.");
//            return;
//        }
//
...
//            resp.setContentType("text/plain");
//            resp.setCharacterEncoding("UTF-8");
//            resp.getWriter().write("Error: Magazine not found.");
//            return;
//        }
